...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hkw99wo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hkw99wo.containers.anotherwebservice.com/
...
```
git clone git@github.com:prabathio/container-hkw99wo.git
cd container-hkw99wo
```
...
```
docker attach container-hkw99wo
```
